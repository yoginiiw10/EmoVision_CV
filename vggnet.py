...
# Compile the model2
vgg_model.compile(loss='categorical_crossentropy', optimizer=Adam(learning_rate=0.0001, decay=1e-6), metrics=['accuracy'])

# Set up CSV logger
csv_logger = CSVLogger('vgg_training.log')
...
vgg_model.save('emotion_detection_model_vgg.h5')
